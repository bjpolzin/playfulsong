...
dds_rat <- DESeqDataSetFromMatrix(countData = rat_rsem_integer,
                                  ...
                                  design = ~ play_group + housing_group)
...
# From the filtered_starling dataset, select and sort genes that belong to the identified OGs based on log fold change.
final_down_genes <- filtered_starling %>%
